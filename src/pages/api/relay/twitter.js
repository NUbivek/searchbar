 ...
 * Twitter OAuth Relay
 * 
 * This endpoint receives Twitter OAuth callbacks on your production site (research.bivek.ai)
...
export default function handler(req, res) {
  ...
  <head>
    ...
    <title>Twitter OAuth Relay - research.bivek.ai</title>
    <style>
      body {
