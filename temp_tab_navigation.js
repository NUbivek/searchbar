...
const TabNavigation = ({ 
  ...
  // If only one tab, don't show the tab header, just the content
  if (tabs.length === 1) {
    return (
      <div className={styles.tabContainer} data-testid="tab-navigation-single">
        {/* Single tab - don't show header, just content */}
